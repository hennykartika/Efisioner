...
<div class="content-wrapper">
    <h3 class="page-heading mb-4">Jawaban Survey <?= $data['namasurvey'] ?></h3>
    <div class="card">
        <div class="card-body">
                ...
                <div class="table-responsive">
                    <table class="table table-bordered">
                        <tbody>
                            ...
                            <tr class="<?php if ($listjawaban['jawaban'] == 'A') echo 'bg-success'; ?>">
                                <td></td>
                                <td>A. </td>
                            </tr>
                            <tr class="<?php if ($listjawaban['jawaban'] == 'B') echo 'bg-success'; ?>">
                                <td></td>
                                <td>B. <?php echo $data['b']; ?></td>
                            </tr>
                            <tr class="<?php if ($listjawaban['jawaban'] == 'C') echo 'bg-success'; ?>">
                                <td></td>
                                <td>C. <?php echo $data['c']; ?></td>
                            </tr>
                            <tr class="<?php if ($listjawaban['jawaban'] == 'D') echo 'bg-success'; ?>">
                                <td></td>
